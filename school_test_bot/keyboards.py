...
button_11_2 = InlineKeyboardButton(text='ДО-', callback_data='false')
button_12_1 = InlineKeyboardButton(text='ДОВЕР-', callback_data='true')
button_12_2 = InlineKeyboardButton(text='-ВЕР-', callback_data='false')
button_12_3 = InlineKeyboardButton(text='ДОВЕРЧИВ-', callback_data='false')
button_13_1 = InlineKeyboardButton(text='не имеет', callback_data='false')
button_13_2 = InlineKeyboardButton(text='-ЧИВ-', callback_data='true')
button_13_3 = InlineKeyboardButton(text='-ИВ-', callback_data='false')
button_14_1 = InlineKeyboardButton(text='не имеет', callback_data='false')
button_14_2 = InlineKeyboardButton(text='-ВЫЙ', callback_data='false')
button_14_3 = InlineKeyboardButton(text='-ЫЙ', callback_data='true')

button_21 = InlineKeyboardButton(text='Двустволка', callback_data='false')
button_22 = InlineKeyboardButton(text='Руководитель', callback_data='false')
button_23 = InlineKeyboardButton(text='Водопровод', callback_data='true')
button_24 = InlineKeyboardButton(text='Кинолюбитель', callback_data='false')
button_25 = InlineKeyboardButton(text='Нет правильного ответа', callback_data='false')

button_31 = InlineKeyboardButton(text='Собственник', callback_data='false')
button_32 = InlineKeyboardButton(text='Соплеменник', callback_data='true')
button_33 = InlineKeyboardButton(text='Солист', callback_data='false')
button_34 = InlineKeyboardButton(text='Соусник', callback_data='false')
button_35 = InlineKeyboardButton(text='Сорняк', callback_data='false')

button_41 = InlineKeyboardButton(text='Вечный, вечерний, привечать', callback_data='false')
button_42 = InlineKeyboardButton(text='Проводник, проводить, водный', callback_data='false')
button_43 = InlineKeyboardButton(text='Рюкзак, в рюкзаке, с рюкзаком', callback_data='false')
button_44 = InlineKeyboardButton(text='Барс, барсук, барствовать', callback_data='false')
button_45 = InlineKeyboardButton(text='Вокзал, вокал, вокальный', callback_data='false')
button_46 = InlineKeyboardButton(text='Дворняга, двор, дворовый', callback_data='true')

button_51 = InlineKeyboardButton(text='Все, кроме 5', callback_data='false')
button_52 = InlineKeyboardButton(text='Все слова', callback_data='true')
...
button_55 = InlineKeyboardButton(text='1, 4, 5', callback_data='false')
button_56 = InlineKeyboardButton(text='Все, кроме 1', callback_data='false')

button_61 = InlineKeyboardButton(text='[ч], [щ], [с]', callback_data='false')
button_62 = InlineKeyboardButton(text='[щ], [з], [й]', callback_data='false')
button_63 = InlineKeyboardButton(text='[й], [л], [ч]', callback_data='false')
button_64 = InlineKeyboardButton(text='[й], [ч], [щ]', callback_data='true')

button_71 = InlineKeyboardButton(text='только в 4', callback_data='false')
button_72 = InlineKeyboardButton(text='во всех, кроме 1', callback_data='true')
button_73 = InlineKeyboardButton(text='только в 2 и 3', callback_data='false')
button_74 = InlineKeyboardButton(text='во всех, кроме 3', callback_data='false')
button_75 = InlineKeyboardButton(text='во всех', callback_data='false')

button_81 = InlineKeyboardButton(text='8', callback_data='false')
button_82 = InlineKeyboardButton(text='4', callback_data='false')
button_83 = InlineKeyboardButton(text='11', callback_data='false')
button_84 = InlineKeyboardButton(text='7', callback_data='true')
button_85 = InlineKeyboardButton(text='10', callback_data='false')


#клавы длы каждого вопроса РЯ

# big russian question nomber 1
...
button_1_3 = InlineKeyboardButton(text='С-лжец, А-шпион, В-рыцарь', callback_data='true')
...
button_2_5 = InlineKeyboardButton(text='Сидоров, Титов, Иванов', callback_data='true')
